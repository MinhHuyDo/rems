                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active" style="color:gold">Enquiry</li>
                                </ol>
                            </div>
...
<tr>
  ...
  <tr align="center">
    <td colspan="2"><button type="submit" name="submit" class="btn btn--primary" style="background-color:gold;color:black"></i> Update</button></td>
  </tr>
  </form>
<?php } else { ?>
<tr>

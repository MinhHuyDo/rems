                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="slider--content">
                            ...
                            <form class="mb-0" method="post" name="search" action="property-search.php"style="box-shadow: 2px 2px 7px">
...
?>
                                        ...
                                        <!-- .col-md-3 end -->
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                            <input type="submit" value="Search" name="search" class="btn btn--primary btn--block" style="background-color:black">
                                        </div>

...
<header id="navbar-spy" class="header header-1 header-transparent header-fixed" >
            <nav id="primary-menu" class="navbar navbar-fixed-top"style="background-color:gold;">
                ...
                <span class="icon-bar"></span>
                 ...
                 <a class="logo" href="index.php">
                    <strong style="color:yellow; font-size:18px;">Company name</strong>
                </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse pull-right " id="navbar-collapse-1"  >
                        <ul class="nav navbar-nav nav-pos-center navbar-left ">
                            ...
                            <li><a href="about.php" style="color:gold;">about</a></li>

                            <li><a href="properties-grid.php" style="color:gold;">properties</a></li>

                            <li><a href="contact.php" style="color:gold;">contact</a></li>
                              <!-- Profile Menu-->
                            <li class="has-dropdown">
                                <?php if (strlen($_SESSION['remsuid']!=0)) {?>
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle menu-item"style="color:gold;" >My Account</a>
                                <ul class="dropdown-menu" style="background-color:black;">
                                    <li><a href="user-profile.php" style="color:gold;">user profile</a></li>
                                    <li><a href="change-password.php" style="color:gold;">change password</a></li>
                        ...
                        <div class="module module-login pull-left">
                            <?php if (strlen($_SESSION['remsuid']==0)) {?>  
                            <a class="btn-popup" data-toggle="modal" data-target="#signupModule" style="color:gold;">Login</a>
                            <?php } ?>
                                                    ...
                                                    <div class="tab-pane fade in active" id="login" >
                                                        <div class="signup-form-container text-center" >
                                                            <form class="mb-0" method="post" name="signin">
                                                                ...
                                                                <div class="or-text">
                                                                <span style="color: gold; background-color:black">Company name</span>
                                                            </div>
                                                                ...
                                                                <input type="submit" name="signin" class="btn btn--primary btn--block" style="color: gold; background-color:black; border: 2px solid gold;" value="Sign In">
                                                    ...
                                                    <div class="tab-pane" id="signup">
                                                        <form class="mb-0" method="post" name="signup">
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <input type="submit" class="btn btn--primary btn--block" name="signup" style="color: gold; background-color:black; border: 2px solid gold;" value="Register">
                                                        </form>
                                                        <!-- form  end -->
                                                    </div>
                        ...
                        <div class="module module-property pull-left">
                            <a href="add-property.php"  class="btn" style="color: gold; background-color:black; border: 2px solid gold;"><i class="fa fa-plus" ></i> add property</a>
                        </div>
                        <?php  }
                       ?>
                    </div>

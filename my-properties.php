...
============================================ -->
                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active" style="color:gold">my properties</li>
                                </ol>
                            </div>
        ...
        <!-- #my properties
============================================= -->
        <section id="my-properties" class="my-properties properties-list"style="background-color:black">
            <div class="container">
                <div class="row">
...
============================================= -->
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                        <h3>Join our professional team & agents to start selling your house</h3>
                         <a href="contact.php" class="btn btn--primary" style="background-color:gold; color:black">Contact</a>
                    </div>
                    <!-- .col-md-6 -->
                </div>
                <!-- .row -->
        ...
        <!-- Footer #1
============================================= -->
        <footer id="footer" class="footer footer-1" style="background-color:black">
            <!-- Widget Section
	============================================= -->
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-3 widget--about">
                            <div class="widget--content">
                                ...
                                <p style="color:white">702 Nguyen Van Linh road , Tan Hung, District 7, HCM city</p>
                                <div class="footer--contact">
                                    <ul class="list-unstyled mb-0">
                                        <li style="color:white">+8405880000</li>
                                        <li><a href="mailto:contact@land.com" style="color:white">contact@land.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-2 col-md-offset-1 widget--links">
                            <div class="widget--title">
                                <h5 style="color:gold">Company</h5>
                            </div>
                            <div class="widget--content">
                                <ul class="list-unstyled mb-0">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-2 widget--links">
                            <div class="widget--title">
                                <h5 style="color:gold">Learn More</h5>
                            </div>
                            <div class="widget--content">
                                <ul class="list-unstyled mb-0">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 widget--newsletter">
                            <div class="widget--title">
                                <h5 style="color:gold">newsletter</h5>
                            </div>
                            <div class="widget--content">
                                ...
                                <h6 style="color:gold">Get In Touch</h6>
                ...
                <div class="container">
                    <div class="row footer--bar">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <span class="color: white">© 2022 <a href="https://www.facebook.com/profile.php?id=100024147370331">Huy*2 cooperation</a>, All Rights Reserved.</span>
                        </div>

                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"style="color:gold">user Profile</li>
                                </ol>
                            </div>
...
?>
                            ...
                            <input type="submit" value="Save Edits" name="submit" class="btn btn--primary" style="background-color:gold;color:black">
                        </form>
                    </div>
                    <!-- .col-md-8 end -->
                </div>

...
============================================ -->
        <section id="page-title" class="page-title bg-overlay">
            <div class="bg-section">
                <img src="assets/images/about/gold.jpg" alt="Background" />
            </div>
            <div class="container">
                <div class="row">
                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active" style="color:gold">Single Property</li>
                                </ol>
                            </div>
...
============================================= -->
        <section id="property-single-gallery" class="property-single-gallery"style="background-color:black">
            <?php 
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="property-single-gallery-info">
                            <div class="property--info clearfix">
                                <div class="pull-left">
                                    <h5 class="property--title"style="color:Gold"><?php echo $row['PropertyTitle'];?></h5>
                                    <p class="property--location"style="color:white"><?php echo $row['Address'];?>, <?php echo $row['CountryName'];?>, <?php echo $row['StateName'];?>,<?php echo $row['City'];?>,<?php echo $row['ZipCode'];?></p>
                                </div>
                                <div class="pull-right">
                                    <span class="property--status"style="color:white"><?php echo $row['Status'];?></span>
                                    <p class="property--price"style="color:Gold"><?php echo $row['RentorsalePrice'];?></p>
                                </div>
                            </div>
                            <!-- .property-info end -->
                            <div class="property--meta clearfix">
                                <div class="pull-left">
                                    <ul class="list-unstyled list-inline mb-0">
                                        <li style="color:gold">
                                            Property ID: <span class="value"style="color:white"><?php echo $row['PropertyID'];?></span>
                                        </li>
                        ...
                        <div class="property-single-desc inner-box">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-4">
                                    <div class="feature-panel">
                                        <div class="feature--content">
                                            <h5>Area:</h5><p><?php echo $row['Area'];?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- feature-panel end -->
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-4">
                                    <div class="feature-panel">
                                        <div class="feature--content">
                                            <h5>Beds:</h5><p><?php echo $row['Bedrooms'];?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- feature-panel end -->
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-4">
                                    <div class="feature-panel">
                                        <div class="feature--content">
                                            <h5>Baths:</h5><p><?php echo $row['Bathrooms'];?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- feature-panel end -->
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-4">
                                    <div class="feature-panel">
                                        <div class="feature--content">
                                            <h5>Size:</h5><p><?php echo $row['Size'];?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- feature-panel end -->
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-4">
                                    <div class="feature-panel">
                                        <div class="feature--content">
                                            <h5>Floors:</h5><p><?php echo $row['Floors'];?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- feature-panel end -->
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-4">
                                    <div class="feature-panel">
                                        <div class="feature--content">
                                            <h5>Garage:</h5><p><?php echo $row['Garages'];?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- feature-panel end -->
...
?>
                         ...
                         <?php } ?>
                            ...
                            <div class="widget--content">
                                <a href="#">
                                    <div class="agent--img">
                                        <img src="assets/images/about/profile picture.jpg" alt="agent" class="img-responsive" height="100" width="100">
                                    </div>
                        ...
                        <div class="widget widget-request">
                            ...
                            <div class="widget--content">
                                <form class="mb-0" method="post">
                                    ...
                                    <!-- .form-group end -->
                                    <input type="submit" value="Send Request" name="submit" class="btn btn--primary btn--block" style="background-color:gold; color:black">
                                </form>
                            </div>
                        </div>
                        <!-- . widget request end -->

...
============================================ -->
        ...
        <!-- properties-grid
============================================= -->
        <section id="properties-grid" style="margin-top:-10%; background-color:#0F0E0E;" >
            <div class="container">
                <div class="row">
...
=============================-->
                        ...
                        <div class="widget widget-property"style="box-shadow: 5px 5px 15px gold">
...
<?php } ?>
                          ...
                          <ul class="pagination" >
        <li ><a href="?pageno=1" Style="color:gold">First</a></li>
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>" style="background-color:#0F0E0E; color:white">Prev</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>"style="background-color:#0F0E0E; color:white">Next</a>
        </li>
        <li><a href="?pageno=<?php echo $total_pages; ?>"Style="color:gold">Last</a></li>
    </ul>
                            </div>
                            <!-- .col-md-12 end -->
                        </div>

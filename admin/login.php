...
<body Style="background-color:grey">
    ...
    <div class="splash-container"style="background-color:black" >
        <div class="card "style="background-color:black">
            <div class="card-header text-center"style="background-color:black"><h2 style="color: gold;background-color:black">CONSOLE</h2><span class="splash-description"style="background-color:black;color:white">Please enter your user information.</span></div>
            <div class="card-body">

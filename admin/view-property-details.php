                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"style="color:white">View Details </h2>
                            
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="dashboard.php" class="breadcrumb-link"style="color:white">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="add-country.php" class="breadcrumb-link"style="color:white">View Details</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"style="color:gold">View Details</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>

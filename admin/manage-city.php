                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"style="color:white">City</h2>
                           
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="dashboard.php" class="breadcrumb-link"style="color:white">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="manage-city.php" class="breadcrumb-link"style="color:gold">Manage City</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>

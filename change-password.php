...
============================================ -->
                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"style="color:gold">Change Password</li>
                                </ol>
                            </div>
        ...
        <!-- #user-profile
============================================= -->
        <section id="user-profile" class="user-profile"style="background-color:#0F0E0E">
            <div class="container">
                <div class="row">
                   <?php include_once('includes/sidebar.php');?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        ...
                        <form class="mb-0" method="post" name="changepassword" onsubmit="return checkpass();">
                            ...
                            <div class="form-box"style="box-shadow: 5px 5px 15px gold">
                                <?php
$uid=$_SESSION['remsuid'];
...
?>
    ...
    echo $msg;
                            ...
                            <input type="submit" value="Save Edits" name="submit" class="btn btn--primary"style="color:black;background-color:gold">
                        </form>
                    </div>
                    <!-- .col-md-8 end -->
                </div>

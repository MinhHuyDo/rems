...
============================================ -->
                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"style="color:gold">Contact</li>
                                </ol>
                            </div>
        ...
        <!-- Contact #1
============================================= -->
        <section id="contact" class="contact contact-1" style="background-color:black">
            <div class="container">
                <div class="row">
                    <?php
...
?>
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="heading heading-2 mb-55">
                            <h2 class="heading--title" style="color:gold">Get In Touch</h2>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-1   " style="background-color:black">
                    
                        <div class="about--img"><img class="img-responsive" src="assets/images/about/trust.jpg" width="500"  alt="about img"></div>
                    </div>
                    <!-- .col-md-8 end -->
                </div>
               <?php } ?>

...
============================================ -->
                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"style="color:gold">About</li>
                                </ol>
                            </div>
        ...
        <!-- about #1
============================================= -->
        <section id="about" style="background-color:black;" class="about " >
            <div class="container" style="background-color:black">
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5">
                        <div class="about--img"><img class="img-responsive" src="assets/images/about/logo.jpg" width="350" height="350" alt="about img"></div>
                    </div>
                    <!-- .col-md-5 -->
...
?>
                        <div class="heading heading-3">
                            <h2 class="heading--title" style="color:gold"><?php echo $row['PageTitle'];?></h2>
                        </div>
                        <!-- .heading-title end -->

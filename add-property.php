                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                ...
                                <ol class="breadcrumb">
                                    <li><a href="#">Home</a></li>
                                    <li class="active" style="color:gold">Add Property</li>
                                </ol>
                            </div>
...
============================================= -->
        ...
        <section id="add-property" class="add-property"style="background-color:#0F0E0E">
    ...
    echo $msg;
            ...
            <div class="col-xs-12 col-sm-4 col-md-4">
                            ...
                            <!-- .form-box end -->
                            <input type="submit" value="Submit" name="submit" class="btn btn--primary"style="color:black;background-color:gold">
                        </form>
                    </div>
                    <!-- .col-md-12 end -->
                </div>
